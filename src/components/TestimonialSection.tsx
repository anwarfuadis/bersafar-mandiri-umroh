...
const TestimonialSection = () => {
  ...
  return <section className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-spiritual-700 via-spiritual-600 to-spiritual-800">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-20 grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 bg-spiritual-800/30 backdrop-blur-sm p-6 md:p-8 border border-spiritual-600/20 mt-16 rounded-sm my-[169px]">
          {[{
          number: "1000+",
