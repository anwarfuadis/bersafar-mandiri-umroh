      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-spiritual-600 font-sf leading-relaxed mb-6">
              Platform Umroh Mandiri pertama di Indonesia. Pilih layanan yang kamu butuhkan, skip yang tidak.
            </p>
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-spiritual-100 rounded-full flex items-center justify-center hover:bg-spiritual-200 transition-colors cursor-pointer">
          ...
          {/* Layanan */}
          <div>
            <h4 className="text-xl font-sf font-semibold text-spiritual-800 mb-6">
              Layanan
            </h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-spiritual-800 font-sf font-medium">WhatsApp</div>
                  <div className="text-spiritual-600 font-sf">+62 812-3456-7890</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="text-lg mt-1">✉️</span>
                <div>
                  <div className="text-spiritual-800 font-sf font-medium">Email</div>
                  <div className="text-spiritual-600 font-sf">support@bersafar.id</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <span className="text-lg mt-1">📍</span>
                <div>
                  <div className="text-spiritual-800 font-sf font-medium">Alamat</div>
                  <div className="text-spiritual-600 font-sf">Jakarta, Indonesia</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Bottom section */}
        <div className="border-t border-spiritual-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-spiritual-600 font-sf text-sm">
