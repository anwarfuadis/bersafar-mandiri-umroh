...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      transform: `translateY(${scrollY * 0.5}px)`
        ...
        <div className="absolute top-20 left-10 w-32 h-32 border-4 border-gold-300/80 rounded-full animate-pulse-gentle shadow-lg" style={{
        transform: `translateY(${scrollY * 0.3}px)`
      }}></div>
        <div className="absolute bottom-40 right-20 w-24 h-24 border-4 border-sand-200/80 rounded-full animate-pulse-gentle shadow-lg" style={{
        animationDelay: '1s',
        transform: `translateY(${scrollY * 0.4}px)`
      }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 border-4 border-gold-200/80 transform rotate-45 animate-pulse-gentle shadow-lg" style={{
        animationDelay: '2s',
        transform: `rotate(45deg) translateY(${scrollY * 0.2}px)`
      }}></div>
        
        {/* Additional geometric shapes - enhanced visibility */}
        <div className="absolute top-1/3 right-1/6 w-20 h-20 border-4 border-gold-400/70 transform rotate-12 shadow-lg" style={{
        transform: `rotate(12deg) translateY(${scrollY * 0.35}px)`
      }}></div>
        <div className="absolute bottom-1/3 left-1/6 w-28 h-28 border-4 border-sand-300/70 rounded-full shadow-lg" style={{
        transform: `translateY(${scrollY * 0.25}px)`
      }}></div>
        <div className="absolute top-1/4 left-2/3 w-12 h-12 bg-gold-300/40 transform rotate-45 shadow-lg" style={{
        transform: `rotate(45deg) translateY(${scrollY * 0.45}px)`
      }}></div>
        <div className="absolute bottom-1/4 right-2/3 w-36 h-36 border-4 border-spiritual-400/60 rounded-full shadow-lg" style={{
        transform: `translateY(${scrollY * 0.15}px)`
      }}></div>
        
        {/* Enhanced Star Pattern - more visible */}
        <div className="absolute top-1/4 right-1/4 text-gold-300/70 text-5xl animate-pulse-gentle drop-shadow-lg" style={{
        transform: `translateY(${scrollY * 0.6}px)`
      }}>✦</div>
        <div className="absolute top-1/3 left-1/6 text-sand-200/70 text-3xl animate-pulse-gentle drop-shadow-lg" style={{
        animationDelay: '1.5s',
        transform: `translateY(${scrollY * 0.3}px)`
      }}>✦</div>
        <div className="absolute bottom-1/3 right-1/6 text-gold-200/70 text-4xl animate-pulse-gentle drop-shadow-lg" style={{
        animationDelay: '2.5s',
        transform: `translateY(${scrollY * 0.4}px)`
      }}>✦</div>
        <div className="absolute top-2/3 left-1/3 text-gold-400/60 text-2xl animate-pulse-gentle drop-shadow-lg" style={{
        animationDelay: '3s',
        transform: `translateY(${scrollY * 0.5}px)`
      }}>✦</div>
        <div className="absolute bottom-2/3 right-1/3 text-sand-300/60 text-3xl animate-pulse-gentle drop-shadow-lg" style={{
        animationDelay: '0.5s',
      ...
      <div className="absolute inset-0 bg-gradient-radial from-transparent via-spiritual-800/10 to-spiritual-900/20" style={{
      transform: `translateY(${scrollY * 0.3}px)`
    }}></div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce opacity-70" style={{
