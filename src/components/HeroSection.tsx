...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      transform: `translateY(${scrollY * 0.5}px)`
        ...
        <div className="absolute bottom-40 right-20 w-24 h-24 border-2 border-sand-200/30 rounded-full animate-pulse-gentle" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 border-2 border-gold-200/30 transform rotate-45 animate-pulse-gentle" style={{
        animationDelay: '2s'
      }}></div>
        
        {/* Star Pattern */}
        <div className="absolute top-1/4 right-1/4 text-gold-300/20 text-4xl animate-pulse-gentle">✦</div>
        <div className="absolute top-1/3 left-1/6 text-sand-200/20 text-2xl animate-pulse-gentle" style={{
        animationDelay: '1.5s'
      }}>✦</div>
        <div className="absolute bottom-1/3 right-1/6 text-gold-200/20 text-3xl animate-pulse-gentle" style={{
        animationDelay: '2.5s'
      }}>✦</div>
      </div>

      {/* Parallax Overlay Gradient */}
      <div className="absolute inset-0 bg-gradient-radial from-transparent via-spiritual-800/20 to-spiritual-900/40" style={{
